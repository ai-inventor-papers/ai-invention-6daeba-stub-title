...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 1 task(s)
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 3 prompts
    - `chat/prompts/2_test_idea/round_1/4_gen_paper_text.md` — 2 prompts
  ...
  - round_2
    ...
    - `3_gen_art/` — 1 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 3 prompts
  ...
  - round_3
    ...
    - `3_gen_art/` — 1 task(s)
      - `chat/prompts/2_test_idea/round_3/3_gen_art/gen_art_experiment_1.md` — 3 prompts
    - `chat/prompts/2_test_idea/round_3/4_gen_paper_text.md` — 2 prompts
  ...
  - round_4
    ...
    - `3_gen_art/` — 1 task(s)
      - `chat/prompts/2_test_idea/round_4/3_gen_art/gen_art_experiment_1.md` — 3 prompts
    - `chat/prompts/2_test_idea/round_4/4_gen_paper_text.md` — 2 prompts
    - `chat/prompts/2_test_idea/round_4/5_review_paper.md` — 2 prompts
    - `chat/prompts/2_test_idea/round_4/6_upd_hypo.md` — 2 prompts
  - round_5
    - `chat/prompts/2_test_idea/round_5/1_gen_strat.md` — 2 prompts
    - `2_gen_plan/` — 1 task(s)
      - `chat/prompts/2_test_idea/round_5/2_gen_plan/gen_plan_experiment_1.md` — 2 prompts
    - `3_gen_art/` — 1 task(s)
      - `chat/prompts/2_test_idea/round_5/3_gen_art/gen_art_experiment_1.md` — 3 prompts
    - `chat/prompts/2_test_idea/round_5/4_gen_paper_text.md` — 2 prompts
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 1 task(s)
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_1.md` — 2 prompts
  - `2_gen_demo_art/` — 5 task(s)
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 2 prompts
  ...
  - `3_gen_full_paper/` — 2 task(s)
    - `chat/prompts/3_report_results/3_gen_full_paper/gen_full_paper.md` — 2 prompts
    - `chat/prompts/3_report_results/3_gen_full_paper/gen_paper_site.md` — 2 prompts
